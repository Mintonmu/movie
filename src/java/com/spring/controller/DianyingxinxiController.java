...
public class DianyingxinxiController extends BaseController {
    ...
    @Autowired
    private PingjiaMapper pdao;
    @Autowired
    private PingjiaService pservice;
    ...
    public String detailweb() {
        ...
        Example example = new Example(Pingjia.class);
        Example.Criteria criteria = example.createCriteria();
        String where = " vid='" + id + "' ";
        where += getWhere();
        ...
        page = Math.max(1, page);
        List<Pingjia> list = pservice.selectPageExample(example, page, 12);
        request.setAttribute("list", list);
    ...
    public String commentadd() {
        ...
        Integer score = Request.getInt("rankscore");
        Integer vid = Request.getInt("vid");
        ...
        pingjia.setCreatetime(Info.getDateStr());

        System.out.println(pingjia);

        pservice.insert(pingjia);
