...
<form  action="goupiaoupdate.do"  method="post" name="form1" id="form1">
    ...
    <table width="100%" class="table table-insert" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse">
                    ...
                    <td width="200">票价：</td>
                    <td>
                        <fmt:formatNumber type="number" value="${(mmm.piaojia * zk) == 0 ? mmm.piaojia: (mmm.piaojia* zk)}" pattern="0.0"/>
                        <input type="hidden" id="piaojia" name="piaojia" value="<fmt:formatNumber type="number" value="${(mmm.piaojia * zk) == 0 ? mmm.piaojia: (mmm.piaojia* zk)}" pattern="0.0"/>" />                                                                     </td>
                </tr>
                                                            <tr>
                    <td width="200">放映厅：</td>
                    <td>
