                    ...
                    <TABLE cellSpacing=0 cellPadding=0 width=740 border=0>
                        ...
                        <TR>
                            ...
                            <TD class=form-right>
                                <table>
                                    <tr>
                                        <td><input type="radio" name="pay_bank" value="directPay" checked><label>支付宝支付</label></td>
                                    </tr>
                                </table>
                            </TD>
                        </TR>
                        <TR>
                            ...
                            <TD class=form-star></TD>
                            <TD class=form-right>
                                <button onClick="location.href='../zhifu.jsp?id=<%=request.getParameter("id")%>&biao=<%=request.getParameter("biao")%>&referer='+encodeURIComponent(document.referrer);">确认订单</button>
                            </TD>
                        </TR>
                    </TABLE>
                </td>
