...
function showUploadImages(  id  ) {
    ...
    var $tpl=$('<fieldset class="images_box">'+
        '<legend style="display:;width: auto;border-bottom:none;"><button class="btn btn-primary btn-block uploadBtn" type="button"> <span class="fa fa-cloud-upload"></span>upload pic</button></legend>'+
