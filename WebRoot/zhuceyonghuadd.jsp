                ...
                <form action="zhuceyonghuinsert.do" method="post" name="form1" id="form1">
                    ...
                    <table width="100%" class="table table-insert" border="1" align="center" cellpadding="3"
                        ...
                        <tr>
                            <td width="200">用户名：</td>
                            <td>
                                <input style="width:150px;" data-rule-required="true" data-msg-required="请填写用户名"
                                       remote="checkno.do?checktype=insert&table=zhuceyonghu&col=yonghuming"
                                       data-msg-remote="内容重复了" id="yonghuming" name="yonghuming" value="" type="text"/>
                        ...
                        <tr>
                            <td width="200">密码：</td>
                            <td>
                                <input style="width:150px;" data-rule-required="true" data-msg-required="请填写密码"
                        ...
                        <tr>
                            <td width="200">姓名：</td>
                            <td>
                                <input style="width:150px;" data-rule-required="true" data-msg-required="请填写姓名"
                        ...
                        <tr>
                            ...
                            <td>
                                <input style="width:150px;" data-rule-phone="true" data-msg-phone="请输入正确手机号码"
                                       id="shoujihao" name="shoujihao" value="" type="text"/></td>
                        </tr>
                        <tr>
                            <td width="200">头像：</td>
                            <td>
